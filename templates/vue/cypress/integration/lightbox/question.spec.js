describe("Question", () => {
  ...
  it("should be able to complete with a checkbox answer with images", () => {
    ...
    cy.getSelectedNode().then(node => {
      ...
      cy.getByTestId("choicerow-checkbox-thumbnail-1")
      ...
      cy.wait("@upload")
        ...
        .then(() => {
          ...
          cy.server()
          cy.route("POST", "**/async-upload.php").as("upload")
          cy.getByTestId("choicerow-checkbox-thumbnail-2")
            .getByTestId("import-file-input")
            .attachFile("reddit.png")
          ...
          cy.wait("@upload")
            ...
            .then(() => {
              ...
              cy.server()
              cy.route("POST", "**/async-upload.php").as("upload")
              cy.getByTestId("choicerow-checkbox-thumbnail-3")
                .getByTestId("import-file-input")
                .attachFile("reddit.png")
              ...
              cy.wait("@upload")
                ...
                .then(() => {
                  ...
                  cy.lightbox().within(() => {
                    cy.getByTestId("user-choicerow-checkbox-thumbnail-1").should(
                      "be.visible"
                    )
  ...
  it("should be able to complete with a radio answer with images", () => {
    ...
    cy.getSelectedNode().then(node => {
      ...
      cy.server()
      cy.route("POST", "**/async-upload.php").as("upload")
      cy.getByTestId("choicerow-radio-thumbnail-50")
        .getByTestId("import-file-input")
        .attachFile("reddit.png")
      ...
      cy.wait("@upload")
        ...
        .then(() => {
          ...
          cy.server()
          cy.route("POST", "**/async-upload.php").as("upload")
          cy.getByTestId("choicerow-radio-thumbnail-51")
            .getByTestId("import-file-input")
            .attachFile("reddit.png")
          ...
          cy.wait("@upload")
            ...
            .then(() => {
              ...
              cy.server()
              cy.route("POST", "**/async-upload.php").as("upload")
              cy.getByTestId("choicerow-radio-thumbnail-52")
                .getByTestId("import-file-input")
                .attachFile("reddit.png")
              ...
              cy.wait("@upload")
                ...
                .then(() => {
                  ...
                  cy.lightbox().within(() => {
                    cy.getByTestId("user-choicerow-radio-thumbnail-50").should(
                      "be.visible"
                    )
                    cy.getByTestId(`invalid-feedback`).should("exist")
                    cy.getByTestId(`user-choicerow-radio-52`)
