...
get_header(); ?>
	...
	<div id="primary" class="content-area col-md-12">
		<main id="main" class="post-wrap" role="main">
			...
			<link href="<?php echo get_site_url(); ?>/wp-content/themes/sydney-child/tapestry/tapestry-d3/tapestry.css" rel="stylesheet" />
            <link href="<?php echo get_site_url(); ?>/wp-content/themes/sydney-child/tapestry/tapestry-d3/libs/jquery-ui.min.css" rel="stylesheet" />

            <script src="<?php echo get_site_url(); ?>/wp-content/themes/sydney-child/tapestry/tapestry-d3/libs/jquery.min.js" type="application/javascript"></script>
