...
class TapestryNode implements ITapestryNode
{
    ...
    public function set($node)
    {
        ...
        if (isset($node->thumbnailFileId) && (is_numeric($node->thumbnailFileId) || (is_string($node->thumbnailFileId) && '' !== $node->thumbnailFileId))) {
        ...
        if (isset($node->lockedThumbnailFileId) && (is_numeric($node->lockedThumbnailFileId) || (is_string($node->lockedThumbnailFileId) && '' !== $node->lockedThumbnailFileId))) {
